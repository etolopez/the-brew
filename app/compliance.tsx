...
export default function ComplianceScreen() {
  ...
  const sections = [
    ['complianceScopeTitle', 'complianceScopeBody'],
    ['complianceDataTitle', 'complianceDataBody'],
    ['complianceSecurityTitle', 'complianceSecurityBody'],
    ['complianceUserTitle', 'complianceUserBody'],
    ['complianceAccessibilityTitle', 'complianceAccessibilityBody'],
    ['complianceLimitsTitle', 'complianceLimitsBody'],
  ] as const;
  ...
  return (
    <View style={[styles.root, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={{ paddingTop: insets.top + 22, paddingBottom: insets.bottom + 42, paddingHorizontal: 22 }} showsVerticalScrollIndicator={false}>
        ...
        />
        <Text style={[styles.updated, { color: colors.mutedForeground }]}>{t('complianceUpdated')}</Text>
        <Text style={[styles.intro, { color: colors.foreground }]}>{t('complianceIntro')}</Text>
